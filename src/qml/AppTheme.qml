...
QtObject {
    readonly property color shellBackground: "#0a0c10"
    readonly property color titleBarBackground: "#14181f"
    readonly property color titleBarBorder: "#242b35"
    readonly property color titleText: "#eef3f8"
    ...
    readonly property color menuBorder: "#2a3441"
    readonly property color menuItemText: "#e4e8ed"
    readonly property color menuItemHover: "#2a3441"
